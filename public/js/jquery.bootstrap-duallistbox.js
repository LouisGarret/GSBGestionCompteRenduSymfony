(function(factory) {
  ...
  BootstrapDualListbox.prototype = {
    ...
    setBtnClass: function(value, refresh) {
      ...
      this.elements.moveAllButton.attr('class', 'btn moveall btn-success').addClass(value);
      this.elements.removeAllButton.attr('class', 'btn removeall btn-danger').addClass(value);
      if (refresh) {
        refreshSelects(this);
      }
      return this.element;
